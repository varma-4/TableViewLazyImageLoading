...
//    fileprivate func reachabilityChangedNotify() {
//        guard let reachabiltyUnWrapped = reachability else {
//            return
//        }
//        
//        let status = reachabiltyUnWrapped.connection
//        
//        if status == .wifi || status == .cellular {
//            Utility.fetchSettingsAndEntryPoints()
//            reachabiltyUnWrapped.stopNotifier()
//        }
//    }
